<?php
  ...
  //guardando el id del personal en un array para hacer uso de la funcion de marcar la entrada
	$datos=array($id_personal);

  //instanciando en un objeto la clase Personal
	$obj= new Metodos();
  //validando si es que llego a marcar la entrada
	if($obj->insertarEntrada($datos)==1){
